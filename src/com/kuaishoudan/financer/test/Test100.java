...
//				 WebElement fs=driver.findElements(By.className("XCUIElementTypeCell")).get(0);
//						 List<WebElement> ffs=fs.findElements(By.className("XCUIElementTypeStaticText"))	 ; 
//				for(int i=0;i<ffs.size();i++){
//						 System.out.println("@#$"+ffs.get(0).getText());
//				}
//				 System.out.println(	driver.findElement(By.xpath("//XCUIElementTypeCell/XCUIElementTypeStaticText")).getText()) ;	
