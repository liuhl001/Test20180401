...
public class AppSPUtil {
	...
	// 申请合同**
	public static KSDCase testSQHT(AppiumDriver<WebElement> driver, KSDCase ksd) {
		String actualstatue = "";
	...
	// (申请合同)-申请请款
	public static KSDCase testHTSQQK(AppiumDriver<WebElement> driver, WebDriver webdriver, KSDCase ksd,
			String devicename) {
		String actualstatue = "";
