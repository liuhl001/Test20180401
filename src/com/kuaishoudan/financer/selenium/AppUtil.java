...
public class AppUtil {
	...
	public static AppiumDriver<WebElement> getdriver()
		...
		File app = new File(appDir,
				"Zhihuijinfu.ipa");//  HelloWorld.ipa Zhihuijinfu.ipa financerfinalVersionjiagusign.apk
		DesiredCapabilities capabilities = new DesiredCapabilities();
//		  DesiredCapabilities capabilities = new DesiredCapabilities();
		 capabilities.setCapability("noReset", true);
	      capabilities.setCapability("platformVersion", "9.3");//8.4
	      capabilities.setCapability("platformName", "iOS");//8.4
	        capabilities.setCapability("deviceName", "iPhone");//IPhone 61 iPhone iPhone
	    capabilities.setCapability("udid", "a37e172bee9bc595116594adb4af2a5baad59954");  //a37e172bee9bc595116594adb4af2a5baad59954  e15b30e055cf920d7f93aa086846f50b12dc9bb7
...
//	        capabilities.setCapability("deviceName", "iPhone 6");
	 ...
	 * @param k
	 */
	public static boolean createUser(AppiumDriver<WebElement> driver,
	...
	//	try {
			...
			driver.findElement(
					By.id("请输入户籍地址")).sendKeys(ksd.getAddress());;// 地址
					driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
			driver.findElement(
					By.id("确认"))
					.click();// 确认
	 ...
	 * @param k
	 */
	public static KSDCase addGr(AppiumDriver<WebElement> driver,
		...
		try {
			...
			driver.findElement(
					By.xpath("//XCUIElementTypeButton[@name='去申请'][1]"))
					.click();// 去申请
...
//				}
				...
				driver.findElements(
						By.className("XCUIElementTypeCell")).get(2)
						.click();// 所属商户
				try {
					List<WebElement> supplier = driver.findElements(
				...
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				driver.findElement(
						By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[4]"))
						.click();// 品牌车系
			...
			//		driver.findElement(By.name(ksd.getCarbrand())).click();
				...
				driver.findElements(
						By.className("XCUIElementTypeTextField")).get(0).sendKeys(""+ksd.getCarprice()); // 车辆价格
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				driver.findElements(
						By.className("XCUIElementTypeTextField")).get(1).sendKeys(""+ksd.getSqdk()); ;// 申请贷款
						driver.manage().timeouts().implicitlyWait(35, TimeUnit.SECONDS);
						driver.findElement(By.name("新建贷款")).click();;
						Thread.sleep(500);
						driver.findElements(
								By.className("XCUIElementTypeCell")).get(6)
								.click();;// 还款期数 / 融资期限
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				driver.findElement(
						By.id(""+(ksd.getHkqs()*6)))
				...
				driver.findElements(
						By.className("XCUIElementTypeCell")).get(7)
						.click();;// 金融产品
				Thread.sleep(500);
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				try {
					...
					for (WebElement produc1 : producs) {
						WebElement product=produc1.findElement(By
								.xpath("XCUIElementTypeStaticText[10]"));
					...
					ksd.setProduct(driver
							.findElement(
									By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[8]/XCUIElementTypeStaticText[2]"))
							.getText().trim());
				...
				driver.findElements(
						By.className("XCUIElementTypeCell")).get(8)
						.click();;// 费率
				driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
				try {
					
					driver.findElement(By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[1]")).click();;
					driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
					String rate=driver.findElement(By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[9]/XCUIElementTypeStaticText[2]")).getText();
					ksd.setRate(rate);
					driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
				...
				driver.findElement(
						By.id("请输入备注内容")).sendKeys(ksd.getRemark());// 备注
				driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
...
////XCUIElementTypeApplication[@name="快收单"]/XCUIElementTypeWindow[4]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton
	 ...
	 * @param k
	 */
	public static KSDCase addQy(AppiumDriver<WebElement> driver,
			WebDriver webdriver, String devicename, int k, KSDCase ksd) {
		...
		try {
			...
			driver.manage().timeouts().implicitlyWait(28, TimeUnit.SECONDS);
					...
					driver.findElements(
							By.className("XCUIElementTypeButton")) .get(3).click();// 去申请
		} catch (org.openqa.selenium.NoSuchElementException ex) {
			// TODO Auto-generated catch block
	ex.printStackTrace();
			flag = true;
		...
		if (!flag) {
			try {
				...
				driver.findElements(
						By.className("XCUIElementTypeTextField")).get(0).sendKeys("qiyemc"); // qiye
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				driver.findElements(
						By.className("XCUIElementTypeTextField")).get(1).sendKeys("yinyezhizhao" ); // qiye
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				driver.findElement(By.name("新建贷款")).click();;
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				List<WebElement> buttons=driver.findElements(By.className("XCUIElementTypeButton"));
...
//				}
				...
				driver.findElements(
						By.className("XCUIElementTypeCell")).get(5)
						.click();// 所属商户
				try {
					driver.manage().timeouts().implicitlyWait(28, TimeUnit.SECONDS);
					List<WebElement> supplier = driver.findElements(
				...
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				driver.findElement(
						By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[7]"))
						.click();// 品牌车系
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				try {
				...
				driver.findElements(
						By.className("XCUIElementTypeTextField")).get(2).sendKeys(""+ksd.getCarprice()); // 车辆价格
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				driver.findElement(By.name("新建贷款")).click();;
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				driver.findElements(
						By.className("XCUIElementTypeTextField")).get(3).sendKeys(""+ksd.getSqdk()); ;// 申请贷款
						driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
						driver.findElement(By.name("新建贷款")).click();;
						driver.findElements(
								By.className("XCUIElementTypeCell")).get(9)
								.click();;// 还款期数 / 融资期限
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				driver.findElement(
						By.id(""+(ksd.getHkqs()*6)))
				...
				driver.manage().timeouts().implicitlyWait(18, TimeUnit.SECONDS);
				driver.findElements(
						By.className("XCUIElementTypeCell")).get(10)
						.click();;// 金融产品
				Thread.sleep(500);
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				try {
					...
					ksd.setProduct(driver
							.findElement(
									By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[11]/XCUIElementTypeStaticText[2]"))
							.getText().trim());
				...
				driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
				driver.findElements(
						By.className("XCUIElementTypeCell")).get(11)
						.click();;// 费率
				driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
				try {
					...
					driver.findElement(By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[1]")).click();;
					driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
					String rate=driver.findElement(By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[12]/XCUIElementTypeStaticText[2]")).getText();
					ksd.setRate(rate);
					driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
...
////XCUIElementTypeApplication[@name="快收单"]/XCUIElementTypeWindow[4]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton
	...
	public static KSDCase addTest(AppiumDriver<WebElement> driver,
...
//		}
	...
	public static void login(AppiumDriver<WebElement> driver,
		...
		try {
			...
			driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//XCUIElementTypeApplication/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeSecureTextField")).sendKeys(ksd.getPwd());;
			Thread.sleep(1000);
	...
	public static void logout(AppiumDriver<WebElement> driver) {
		...
		driver.findElement(By.id("defaultIcon"))
				.click();// 头像
		driver.manage().timeouts().implicitlyWait(58, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//XCUIElementTypeButton[@name='退出登录']"))
				.click();// 退出登录
		driver.manage().timeouts().implicitlyWait(48, TimeUnit.SECONDS);
		driver.findElement(
				By.id("是"))
	 ...
	 * @return
	 */
	public static String uploadQk(AppiumDriver<WebElement> driver,
			int imgcount) {
	...
	// 返点费用支出
	public static void testFd(AppiumDriver<WebElement> driver,
